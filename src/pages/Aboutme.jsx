    ...
    <article className={styles.article}>
      ...
      <section className={styles.aboutMe__section}>
        <p className={styles.p}>
          ...
          viktigt det är att skapa användarvänliga och tillgängliga webbplatser.
          Jag älskar utmaningar och ser dem som möjligheter att växa. Att
          ständigt utmana mig själv och lära mig nya saker är något som driver
          mig. Jag tror fast på att bästa sättet att lära sig är genom att göra,
          experimentera och ibland göra misstag. Varje kodrad jag skriver och
          varje projekt jag tar mig an för mig ett steg närmare min dröm om att
          bli en skicklig front-end utvecklare.
        </p>
      </section>
    </article>
  );
